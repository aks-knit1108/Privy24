...
- (void)viewDidLoad {
    ...
    switch (_lockScreenMode) {
        ...
        case LockScreenModeNormal: {
            ...
            [self lsv_updateTitle:@"Enter your Privy passcode"
                         subtitle:@""];
            break;
        }
        case LockScreenModeNew: {
            [self lsv_updateTitle:@"Enter a passcode"
                         subtitle:@""];

            break;
        }
        case LockScreenModeChange:
            [self lsv_updateTitle:@"Enter new passcode"
                         subtitle:@""];
            break;
            
        case LockScreenModeOff:
            [self lsv_updateTitle:@"Enter your Privy passcode"
                         subtitle:@""];
            break;
    }
...
- (void)lsv_unlockScreenFailure {
    ...
    [_subtitleLabel setText:@"Passcode not matched"];
...
- (void)lockScreenPincodeView:(JKLLockScreenPincodeView *)lockScreenPincodeView pincode:(NSString *)pincode {
    ...
    if (_lockScreenMode == LockScreenModeNormal || _lockScreenMode == LockScreenModeOff) {
        ...
        [self lsv_updateTitle:@"Confirm Passcode"
                     subtitle:@""];
